...
import (
	...
	"testing"
	"time"
	"github.com/SHENCaesar/kitex_student/hertz/biz/model/demo"
...
func test_register(stu *demo.Student) (rResp *demo.RegisterResp, err error) {
